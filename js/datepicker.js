    ...
    , selectMonth: function(date) {
        ...
        if (!this.curMonth || !(this.curMonth.getFullYear() == newMonth.getFullYear() &&
          ...
          for (var ii = 0; ii <= num_days; ii++) {
            ...
            var _d = new Date(rangeStart.getFullYear(), rangeStart.getMonth(), rangeStart.getDate() + ii);
            
            if(this.inArray(this.format(_d), this.disableDays) == true)
            {
                /**
                 * @skowron-line
                 * Add class .disabled to div
                 * Push date to disabled array
                 */
                $day.addClass('disabled');
                this.disabled.push(this.format(thisDay));
            }
            //console.log(this.disableBelow + '=> '+ this.format(_d) +' == '+ this.isBelow(this.disableBelow, this.format(_d)));
            if(this.isBelow(this.disableBelow, this.format(_d)) == true)
            {
                /**
                 * @skowron-line
                 * Add class .disabled to div
            ...
            if(this.isAbove(this.disableAbove, this.format(_d)) == true)
            {        
                /**
                 * @skowron-line
                 * Add class .disabled to div
          ...
          $('div', this.$days).click($.proxy(function(e) {
             ...
             * If date is not in disabled array execute click function
             */
            if(this.inArray($targ.attr("date"), this.disabled) == false)
            {
